...
string mons_type_name(monster_type type, actor_i18n_context_type i18n_context);
...
string mon_attack_name(attack_type attack, mon_attack_name_i18n_ctype i18n_context, bool with_object = true);
