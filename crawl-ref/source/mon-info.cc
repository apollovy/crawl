...
string monster_info::_core_name(actor_i18n_context_type i18n_context) const
{
    ACTOR_I18N_CNAME;
...
string monster_info::proper_name(actor_i18n_context_type i18n_context) const
{
    if (has_proper_name())
        return translate_actor(i18n_context, mname.c_str());
    else
